# Quick Start - Inicia tudo de uma vez
$OutputEncoding = [System.Text.Encoding]::UTF8

Write-Host "===========================================================" -ForegroundColor Green
Write-Host "   AgroSolutions Identity API - Quick Start               " -ForegroundColor Green
Write-Host "===========================================================" -ForegroundColor Green
...
try {
    dotnet ef database update --context IdentityDbContext 2>&1 | Out-Null
...
Write-Host "===========================================================" -ForegroundColor Green
Write-Host "`n[i] Swagger: http://localhost:5001" -ForegroundColor Yellow
